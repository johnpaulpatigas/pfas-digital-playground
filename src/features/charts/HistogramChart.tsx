    ...
    <div className="w-full h-64 sm:h-72 md:h-80 pt-2 font-mono select-none">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={binData} margin={{ top: 12, right: 15, left: 0, bottom: 25 }}>
          ...
          <ReferenceLine x={summaryStats.mean.toFixed(3)} stroke="#0d9488" strokeWidth={2} strokeDasharray="4 4" label={{ value: 'Mean', fill: '#0d9488', fontSize: 9, position: 'insideTopLeft' }} />
          <ReferenceLine x={summaryStats.p95.toFixed(3)} stroke="#dc2626" strokeWidth={2} label={{ value: 'P95', fill: '#dc2626', fontSize: 9, position: 'insideTopLeft' }} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
